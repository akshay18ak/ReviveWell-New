        ...
        <div className="card slide-in" style={{ flex: 1, minWidth: '300px' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            {assessments.slice(0, 5).map((assessment) => (
              <li key={assessment.id} style={{ marginBottom: '10px', padding: '10px', backgroundColor: 'var(--input-background)', borderRadius: '5px' }}>
        ...
        <div className="card slide-in" style={{ flex: 1, minWidth: '300px' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            {appointments.slice(0, 5).map((appointment) => (
              <li key={appointment.id} style={{ marginBottom: '10px', padding: '10px', backgroundColor: 'var(--input-background)', borderRadius: '5px' }}>
